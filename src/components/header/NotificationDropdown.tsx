  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="fixed left-2 right-2 top-16 z-[70] mt-0 flex h-[min(480px,calc(100vh-5rem))] w-auto flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:absolute sm:left-auto sm:right-0 sm:top-auto sm:mt-[17px] sm:h-[480px] sm:w-[361px]"
      >
