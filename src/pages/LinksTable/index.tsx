            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="grid w-full grid-cols-3 gap-2 sm:flex sm:w-auto sm:items-center sm:gap-2">
                <a
                  ...
                  className="group relative inline-flex w-full items-center justify-center gap-1 rounded-full border border-[#61ffe3]/60 bg-[#61ffe3]/15 px-2 py-1.5 text-xs font-semibold text-[#61ffe3] hover:bg-[#61ffe3]/25 sm:w-auto sm:px-3 sm:text-sm"
                ...
                <button
                  ...
                  className="inline-flex w-full items-center justify-center gap-1 rounded-full border border-white/40 bg-white/10 px-2 py-1.5 text-xs font-semibold text-white hover:bg-white/20 lg:hidden"
                >
                ...
                <button
                  ...
                  disabled={refreshing}
                  className="inline-flex w-full items-center justify-center gap-1 rounded-full border border-white/40 bg-white/10 px-2 py-1.5 text-xs font-semibold text-white hover:bg-white/20 disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto sm:px-3 sm:text-sm"
                >
                  <RefreshCw
                    size={14}
